<div align="center">
  ...
  <a href="https://support-ticket-system-q9sc4zngc-vamsikiran1234s-projects.vercel.app">
    <img src="./assets/ticketflow-workflow.svg" width="100%" alt="TicketFlow Application Workflow Process" />
  </a>
...
> 💡 **Evaluator Note on Free-Tier Cloud Architecture:**
> - **24/7 Availability:** Automated pings via GitHub Actions (`.github/workflows/keep_alive.yml`) and UptimeRobot keep the Render API active.
> - **Client Pre-Warming:** Opening the frontend web app immediately dispatches a background wake-up ping to the API.
> - Fast sub-second response times across all operations.
